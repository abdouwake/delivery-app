(function () {
  ...
  angular.module("ng-drag-scroll", []).directive("dragScroll", DragScroll);
  ...
  function DragScroll($document, $window, $parse) {
    ...
    var directive = {
      ...
      link: function ($scope, $element, $attributes, vm) {
        ...
        var excludedClasses = $attributes.dragScrollExcludedClasses
          ? $attributes.dragScrollExcludedClasses.split(",")
          : [];
        var startClientX;
        var startClientY;
        var lastClientX;
        ...
        function handleMouseUp(e) {
          if (enabled) {
            var selectable =
              e.target.attributes && "drag-scroll-text" in e.target.attributes;
            var withinXConstraints =
              e.clientX >= startClientX - allowedClickOffset &&
              e.clientX <= startClientX + allowedClickOffset;
            var withinYConstraints =
